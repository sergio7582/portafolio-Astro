import { c as createComponent, a as createAstro, m as maybeRenderHead, r as renderTemplate, b as renderScript, d as addAttribute, A as AstroError, E as ExpectedImage, L as LocalImageUsedWrongly, M as MissingImageDimension, U as UnsupportedImageFormat, I as IncompatibleDescriptorOptions, e as UnsupportedImageConversion, t as toStyleString, N as NoImageMetadata, F as FailedToFetchRemoteImageDimensions, f as ExpectedImageOptions, g as ExpectedNotESMImage, h as InvalidImageService, i as ImageMissingAlt, s as spreadAttributes, j as renderComponent, k as renderSlot, l as renderHead } from './astro/server_B9tfJLiE.mjs';
import 'kleur/colors';
import 'html-escaper';
import 'clsx';
...
const $$About = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section id="about" class="about-section"> <div class="section-container"> <h2 class="section-title">Sobre mi</h2> <div class="about-content"> ${about.content.split("\n").map((paragraph) => renderTemplate`<p class="about-text">${paragraph}</p>`)} </div> </div> </section>`;
}, "C:/Projects/portafolio-Astro/src/components/about.astro", void 0);
...
}, "C:/Projects/portafolio-Astro/node_modules/astro/components/Image.astro", void 0);
...
}, "C:/Projects/portafolio-Astro/node_modules/astro/components/Picture.astro", void 0);
...
const $$Projects = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a$1 || (_a$1 = __template$1(["", '<section id="mywork" class="projects-section" data-astro-cid-lsjgadct> <div class="section-container" data-astro-cid-lsjgadct> <h2 class="section-title" data-astro-cid-lsjgadct>Mis proyectos</h2> <div class="projects-grid" data-astro-cid-lsjgadct> ', ' </div> </div> <!-- Modal --> <div id="imageModal" class="modal" onclick="closeModal()" data-astro-cid-lsjgadct> <div class="modal-content" onclick="event.stopPropagation()" data-astro-cid-lsjgadct> ', ' </div> </div> <script>\n    function openModal(img) {\n      const modal = document.getElementById("imageModal");\n      const expandedImg = document.getElementById("expandedImg");\n      expandedImg.src = img;\n      expandedImg.alt = "Imagen de proyecto expandida"\n      modal.classList.add("open");\n    }\n\n    function closeModal() {\n      document.getElementById("imageModal").classList.remove("open");\n    }\n\n    // Cerrar con ESC\n    document.addEventListener("keydown", (e) => {\n      if (e.key === "Escape") closeModal();\n    });\n\n    // // Close modal when clicking outside\n    window.onclick = function (event) {\n      const modal = document.getElementById("projectModal");\n      if (event.target === modal) {\n        closeModal();\n      }\n    };\n  <\/script> </section> '])), maybeRenderHead(), projects.map((project, index) => renderTemplate`<div class="project-card" data-astro-cid-lsjgadct> <div class="project-image-container" data-astro-cid-lsjgadct> ${renderComponent($$result, "Image", $$Image, { "class": "project-image", "onclick": `openModal('${project.image}')`, "src": project.image, "alt": project.title, "data-astro-cid-lsjgadct": true })} </div> <h3 class="project-title" data-astro-cid-lsjgadct>${project.title}</h3> <div class="project-technologies" data-astro-cid-lsjgadct> ${project.technologies.map((tag) => renderTemplate`<span class="project-tag" data-astro-cid-lsjgadct>${tag.name}</span>`)} </div>  <p class="project-description" data-astro-cid-lsjgadct>${project.details}</p> <ul data-astro-cid-lsjgadct> ${project.listDetails.map((details) => renderTemplate`<li data-astro-cid-lsjgadct>${details}</li>`)} </ul> <div class="project-links" data-astro-cid-lsjgadct> ${project.links.map((link) => renderTemplate`<a${addAttribute(link.url, "href")} class="project-link" data-astro-cid-lsjgadct> <i${addAttribute(`${link.icon} link-icon`, "class")} data-astro-cid-lsjgadct></i>&ensp;${link.text} </a>`)} </div> </div>`), renderComponent($$result, "Image", $$Image, { "src": "/", "id": "expandedImg", "alt": "Text", "width": 100, "height": 100, "data-astro-cid-lsjgadct": true }));
}, "C:/Projects/portafolio-Astro/src/components/projects.astro", void 0);
...
const $$Skills = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section id="skills" class="skills-section"> <div class="section-container"> <h2 class="section-title">Habilidades</h2> <div class="skills-grid"> ${skills.map((skill) => renderTemplate`<div class="skill-card"> <i${addAttribute(`${skill.icon} skill-icon`, "class")}></i> <h3 class="skill-name">${skill.name}</h3> </div>`)} </div> </div> </section>`;
}, "C:/Projects/portafolio-Astro/src/components/skills.astro", void 0);
...
const $$BaseLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(['<html lang="en"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>', '</title><!-- Favicon --><link rel="icon" href="/favicon_laptop.ico"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">', '</head> <body> <header class="header"> <nav class="nav-container"> <input type="checkbox" id="menu-toggle" class="menu-toggle"> <label for="menu-toggle" class="hamburger"> <i class="fas fa-bars"></i> </label> <ul class="nav-list"> <li><a href="#home" class="nav-link">Inicio</a></li> <li><a href="#mywork" class="nav-link">Mis proyectos</a></li> <li><a href="#skills" class="nav-link">Habilidades</a></li> <li><a href="#about" class="nav-link">Sobre mi</a></li> </ul> </nav> </header> <main> ', ' </main> <footer class="footer"> <div class="footer-content"> <p>&copy; 2025 Sergio Saidel Mancinas. All rights reserved.</p> </div> </footer> <script>\n      // Cerrar men\xFA al hacer click en un enlace\n      document.querySelectorAll(".nav-link").forEach((link) => {\n        link.addEventListener("click", () => {\n          document.getElementById("menu-toggle").checked = false;\n        });\n      });\n    <\/script> </body> </html>'])), title, renderHead(), renderSlot($$result, $$slots["default"]));
}, "C:/Projects/portafolio-Astro/src/layouts/BaseLayout.astro", void 0);

const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Sergio Mancinas" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Hero", $$Hero, { "devInfo": devInfo })} ${renderComponent($$result2, "Projects", $$Projects, { "projects": projects })} ${renderComponent($$result2, "Skills", $$Skills, { "skills": skills })} ${renderComponent($$result2, "About", $$About, { "about": about, "skills": skills })} ` })}`;
}, "C:/Projects/portafolio-Astro/src/pages/index.astro", void 0);

const $$file = "C:/Projects/portafolio-Astro/src/pages/index.astro";
const $$url = "";
